process QC_READS_WITH_FASTP {
      ...
      fastp --in1 "\${output_location}/${params.sample}_R1_merged.fastq.gz" \
            ...
            --out1 "\${output_location}/${params.sample}_R1_trimmed.fastq.gz" \
            --out2 "\${output_location}/${params.sample}_R2_trimmed.fastq.gz" \
      ...
      stub:
      """
      echo "Running fastp on ${fastq_r1} and ${fastq_r2} for sample ${params.sample} in dataset ${params.dataset}"
      """
}

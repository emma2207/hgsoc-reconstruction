...
datasets=("hgsoc_ariel" "high_grade_glioma" "high_grade_glioma" "low_grade_glioma" "wilms_tumor" "wilms_tumor")
data_types=("all" "bulk" "single-cell" "all" "bulk" "single-nucleus")

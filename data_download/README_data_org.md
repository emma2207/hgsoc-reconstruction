...
We reorganized the data to group the same data types and add comprehensive labels.
The data described above is now all found in `/pl/active/cgreene-sc-hgsoc/ariel_sc_HGSOC`:
